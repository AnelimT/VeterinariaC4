...
export class PersonaPedidoController {
  ...
  async find(
    ...
    return this.personaRepository.pedido(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.pedido(id).create(pedido);
  }
  ...
  async patch(
    ...
    return this.personaRepository.pedido(id).patch(pedido, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.pedido(id).delete(where);
  }
}
